        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Settings_Doctors_DoctorId",
                        column: x => x.DoctorId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DiscountCodeCoupon", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DiscountCodeCoupon_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TimeSlot_Settings_SettingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DiscountCodeCoupon_PatientId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Settings_DoctorId",
                table: "Settings",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_TimeSlot_SettingId",
                table: "TimeSlot",
                column: "SettingId",
                unique: true);
        }
